"""Wind turbine configuration UI component.

Streamlit form for configuring wind turbine parameters including turbine type,
...
def wind(form_key_suffix=""):
    if "wind_settings" not in st.session_state:
        st.session_state.wind_settings = {
            "Turbine Type": "E-140",
            "Hub Height" : 135,  # meters - typical for E-140
            "Rotor Diameter" : 140,  # meters - E-140 specification
            # "Comfort Factor": 0,
            ...
            "Obstacle Height": 0.0,
            "hellman_exp": 0.2  # typical for open terrain
