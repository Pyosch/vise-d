"""Research paper visualization functions.

This module contains functions to generate figures for research publications,
specifically figures showing electricity pricing, tariff structures, and grid
