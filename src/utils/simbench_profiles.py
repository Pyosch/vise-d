...
def fix_simbench_dtypes(net):
    """Fix dtype issues that SimBench introduces (object columns that should be bool/numeric).

    Needed before pp.runopp(); harmless for pp.runpp(). Call immediately after
    sb.get_simbench_net().
    """
