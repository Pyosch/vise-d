...
def pp_networks():
    ...
    networks = ['Keine Auswahl', 'Einfaches Beispiel', 'Multispannungs-Beispielnetz', '4-Knoten-Stickleitung', 'CIGRE Niederspannungsnetz','Kerber Networks','Dickert LV Networks','3-Phase Grid Data']
    ...
    elif selected_network == 'kerber_landnetz_freileitung_1':
    ...
    pp.runpp(net)
    st.plotly_chart(pp.plotting.plotly.simple_plotly(net), use_container_width=True, height=800)
